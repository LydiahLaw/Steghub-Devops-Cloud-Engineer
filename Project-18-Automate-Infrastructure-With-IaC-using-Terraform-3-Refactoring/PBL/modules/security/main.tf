...
# Allow SSH from Bastion to Nginx
...
# Allow SSH from Bastion to webservers
...
# Allow MySQL port 3306 from Bastion — for manual DB admin
...
# Allow MySQL port 3306 from webservers — for app database connections
